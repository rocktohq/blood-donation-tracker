<?php
    ...
    if(isset($_SESSION['admin'])) {
        ...
        if(isset($_POST['complete'])) {
            ...
            $result = $con->query($sql);
            if($result) {
                $_SESSION['message'] = "Post has been Moved to Completed Requests Section";
                header("Location: requestfeed.php");
            } else {
                $notification = "Something Went Wrong!";
                $border = 'danger';
            ...
            <main>
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Main -->
                        <div class="col-md-9">
                            <h2 class="fw-bold">Recent Requests</h2>
                            <div class="row">
                                <div class="col-12">
                                            ...
                                            <div class="d-flex justify-content-evenly align-items-center"><span class="text-muted"><?php echo $time; ?></span>
                                                <div class="nav-item dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                                        <li>
                                                            <form action="requestfeed.php" method="POST">
                                                                <input type="hidden" name="pid" value="<?php echo $rows['id']; ?>">
                                                                <button class="no-btn" type="submit" name="submit">Delete Post</button>
                                                            </form>
                                                        </li>
                                                        <li>
                                                            <a class="no-btn" href="requestfeed-update.php?id=<?php echo $rows['id']; ?>">Update Post</a>
                                                        </li>
                                                        <li>
                                                            <form action="requestfeed.php" method="POST">
                                                                <input type="hidden" name="pid" value="<?php echo $rows['id']; ?>">
                                                                <button class="no-btn" type="submit" name="complete">Mark: Completed</button>
                                                            </form>
                                                        </li>
                                                    </ul>
                                                </div>

<?php
    ...
    if(isset($_SESSION['admin'])) {
        ...
        if(isset($_POST['submit'])) {
            $doid =  $con->real_escape_string($_POST['doid']);

            $sql = "SELECT * FROM `donation` WHERE `id` = '$doid'";
            ...
            if($result->num_rows > 0) {
                ...
                if($row['approved']) {
                    $value = 0;
                    $text = "Donation Unprroved!";
                } else {
                    $value = 1;
                    $text = "Donation Aprroved!";
                }
            }
                        ...
                        <div class="col-md-3">
                            <nav class="navbar-dark bg-dark">
                                <ul class="navbar-nav">
                                    ...
                                    <li>
                                        <a class="nav-link active px-3" href="donation.php">
                                            <span class="me-2"><i class="bi bi-arrow-right"></i></span>
                                            <span>Donation</span>
                                        </a>
                                    </li>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><form action="donation.php" method="POST">
                                                    <input type="hidden" name="doid" value="<?php echo $row['id']; ?>">
                                                    <button class="btn btn-<?php echo $color; ?>" type="submit" name="submit"><?php echo $action; ?></button>
                                                </form></td>
                                            </tr>
                                            <?php   } } ?>
                                        </tbody>
